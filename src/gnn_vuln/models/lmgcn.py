"""lmgcn.py — LM-GCN: GCNConv + frozen node embeddings."""
from __future__ import annotations
import torch
import torch.nn as nn
from torch_geometric.nn import global_mean_pool
from gnn_vuln.models.base import VulnDetectorBase
from gnn_vuln.models.encoders import GCNEncoder
from gnn_vuln.models.heads import FuncHead, SmallFuncHead, StmtHead

NODE_FEAT_DIM = 773

class LMGCNVulnDetector(VulnDetectorBase):
    def __init__(self, in_channels=NODE_FEAT_DIM, hidden_dim=256, num_layers=4,
                 dropout=0.3, num_classes=11, add_self_loops=False, use_skip=False):
        super().__init__()
        self.encoder   = GCNEncoder(in_channels, hidden_dim, num_layers, dropout, add_self_loops, use_skip)
