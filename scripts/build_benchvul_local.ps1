...
uv run python -m gnn_vuln.data.build_pt --config configs/benchvul/benchvul_ml1024.yaml
uv run python -m gnn_vuln.data.build_pt --config configs/benchvul/benchvul_ml5120.yaml
